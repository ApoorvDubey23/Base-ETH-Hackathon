      ...
      <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-12 lg:px-20">
        <div className="max-w-2xl space-y-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-light-heading dark:text-dark-heading leading-tight">
            Welcome to <span className="bg-gradient-to-r from-light-accent to-light-accent-secondary dark:from-dark-accent dark:to-dark-accent-secondary bg-clip-text text-transparent">MetaBet</span>
          </h1>
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            <Button size="lg" className="flex items-center gap-2 bg-light-accent dark:bg-dark-accent hover:bg-light-accent-hover dark:hover:bg-dark-accent-hover text-light-button-text dark:text-dark-button-text">
              <CirclePlay className="h-5 w-5" />
              Play Now
            </Button>
            <Button size="lg" variant="outline" className="border-light-border dark:border-dark-border bg-light-bg/5 dark:bg-dark-bg/5 backdrop-blur-sm hover:bg-light-bg/10 dark:hover:bg-dark-bg/10 text-light-button-text dark:text-dark-button-text">
              Learn More
            </Button>
          </div>
        </div>
