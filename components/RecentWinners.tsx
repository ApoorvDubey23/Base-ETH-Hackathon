...
const RecentWinners: React.FC = () => {
  const winners: Winner[] = [
    ...
    { username: "MoonWalker", game: "Mines", amount: "$675", time: "10 min ago" },
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-700 text-left">
                ...
                <th className="py-3 px-4 text-sm font-medium text-gray-700 dark:text-gray-300">Amount</th>
              ...
              {winners.map((winner, index) => (
                ...
                >
                  <td className="py-4 px-4 flex items-center">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">{winner.username}</span>
                  </td>
                  <td className="py-4 px-4 text-gray-700 dark:text-gray-300">{winner.game}</td>
                  <td className="py-4 px-4 font-medium text-yellow-500">{winner.amount}</td>
                  <td className="py-4 px-4 text-gray-500 dark:text-gray-400 text-sm">{winner.time}</td>
                </tr>
              ))}
            </tbody>
          </table>
