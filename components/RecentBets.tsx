      ...
      {address ? (
                  ...
                  >
                    ...
                    <td
                      className={`py-4 px-4 font-medium ${
                        player.isWin ? "text-green-500" : "text-red-500"
                      }`}
                    >
                      {player.amount}
                    </td>
        ...
        <div className="w-full px-4 py-6 mt-4 text-center text-gray-700 bg-gray-100 border border-gray-300 rounded-lg shadow-sm">
          <p className="text-lg font-medium">
            Wallet not connected. Please connect your wallet to see the recent
            bets.
          </p>
        </div>
      )}
