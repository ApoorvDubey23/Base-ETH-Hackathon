...
import { Withdraw } from "@/utils/helpers";
  ...
  return (
    <div className="flex flex-col space-y-6 w-full max-w-md p-4 bg-white dark:bg-neutral-900 rounded-lg shadow-md">
      ...
      {cashoutAvailable && withdrawableAmount > 0 && (
        <button
          onClick={cashout}
          className="mt-4  px-4 py-2 bg-green-600 dark:bg-green-800 text-white rounded-md shadow hover:bg-green-700 dark:hover:bg-green-900 transition-colors duration-200"
        >
          {isWithdrawing ? (
            <>
